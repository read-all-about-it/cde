...
* [`src/cde/styles.cljs`](src/cde/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/cde/`](src/cde/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cde/core.cljs): contains the SPA entry point, `init`
* [`test/cde/`](test/cde/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `cde` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cde/config.cljs) defaults to `true` in
